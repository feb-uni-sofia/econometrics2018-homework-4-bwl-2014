...
## Тези данни не казват абсолютно нищо за това къде са живяли извършителите,
## а само колко престъпления са извършени в даден окръг (county)...
##
##
...
#не отхвърляме хипотезата, че криминалността --не-- зависи от процента население със завършено средно образование.
